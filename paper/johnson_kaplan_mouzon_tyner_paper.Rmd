...
Ineffecient chains are very slow to explore the support of the target distribution.  
This also means that they will take more time to converge to the target distribution.
